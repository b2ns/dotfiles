...
let g:var_enable_background_change_on_sunset=1
" 日出日落时间24制(800==08:00, 1830==18:30)
let g:var_sunrise_time=830
let g:var_sunset_time=1830

if g:var_is_linux
  let g:var_slimv_swank_cmd='! gnome-terminal -e "sbcl --load /home/ding/.vim/bundle/slimv/slime/start-swank.lisp &"'
  let g:var_guifont="InconsolataLGC\ Nerd\ Font\ Mono\ 16"

elseif g:var_is_mac
  let g:var_slimv_swank_cmd='!osascript -e "tell application \"Terminal\" to do script \"sbcl --load ~/.vim/bundle/slimv/slime/start-swank.lisp\""'
